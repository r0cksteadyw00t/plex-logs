...
**Updated UTC:** 2026-06-11T12:40:55.805Z

**Status:** `PASS_UNCAPPED_BASELINE_CAPTURED`

**True baseline:** `89/105` expected affected hybrid_movies_live hashes are currently present in the uncapped Plex Section 5 index snapshot.
...
**Conclusion:** The previous 16/105 result was at least partly a measurement artifact. The uncapped snapshot found 89/105 expected affected hashes currently present in Plex Section 5.
