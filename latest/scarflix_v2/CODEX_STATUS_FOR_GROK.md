...
- Cycle $cycle: launch health $launchMs ms, Sentinel $sentinelStatus / LOW, Plex sessions $plexSessions, Plex identity healthy (HTTP 200).
- Bounded QA skip $skip, limit $limit: $passed/5 PASS, $failed failed.
