...
Updated UTC: 2026-06-07T21:10:00.776Z
Status: PASS
...
| ScarFLIX Catalogue Expansion (Mission 001) | Growth beyond 78 items with alternate-source retry and verified Plex playback. | 2026-06-07T21:09:37.001Z - 5-concurrent stream QA | Actual Streaming library .strm output is movies=18, tv=10, total=28. Direct admission=REVIEW_QUARANTINED_VISIBLE_FAILURES, checked=1, passed_visible=0, quarantined_this_run=1, retry_held=1. Direct mirror=PASS_EXISTING_DELIVERY_WAITING_PLATFORM_GATE, eligible=unknown, already_current=unknown. Legacy WebDAV visible QA rows are 1 and are not counted as direct delivered catalogue. Snapshot health=REVIEW; global health=UNKNOWN (blocking=false); blocked_by=snapshot_scoped_qa. Canary=STAGING_CANDIDATES/CANARY_STAGING_STARTED, staged=0, new_visible_strm=0. PlatformGate=REVIEW/REVIEW; durable=REVIEW; child_stage=5-concurrent stream QA; child_age=under 1 min; owner_pid=33492; child_pid=. | 15% | after PlatformGate and candidate model PASS | Low |
| Fast-Track Accelerator | Push short autonomous status, prediction, candidate and expansion actions every 5 minutes. | 2026-06-07T21:09:03Z - PLATFORM_GATE_RUNNING | Status PASS; expansion_eligible=false; expansion_started_this_cycle=false; total_strm=28. | 25% | runs every 5 minutes | Low |
...
- 2026-06-07T21:09:04Z - Durable PlatformGate runner RUNNING: Step running_platform_gate_attempt_1; owner_pid=33492; child_pid=35472
- 2026-06-07T21:09:04Z - PlatformGate checkpoint RUNNING: Step running_platform_gate_attempt_1; visible=1; blockers=0
