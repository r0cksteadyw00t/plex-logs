...
Updated UTC: 2026-06-07T23:02:32.451Z
Status: PASS
...
| ScarFLIX Catalogue Expansion (Mission 001) | Growth beyond 78 items with alternate-source retry and verified Plex playback. | 2026-06-07T23:02:31.284Z - Plex visible/HLS QA | Actual Streaming library .strm output is movies=21, tv=10, total=31. Staged pending=36; staged publisher=PASS_PUBLISHED, processed=8, published=1. Direct admission=REVIEW_RETRY_HELD, checked=30, passed_visible=30, quarantined_this_run=0, retry_held=7. Direct mirror=PASS_EXISTING_DELIVERY_WAITING_PLATFORM_GATE, eligible=unknown, already_current=unknown. Legacy WebDAV visible QA rows are 1 and are not counted as direct delivered catalogue. Snapshot health=REVIEW; global health=UNKNOWN (blocking=false); blocked_by=snapshot_scoped_qa. Canary=WAITING_PLATFORM_GATE_WITH_STAGED_CANDIDATES/CANARY_READY_TO_PUBLISH_AFTER_GATE, staged=42, new_visible_strm=-8. PlatformGate=REVIEW/RUNNING; durable=RUNNING; child_stage=Plex visible/HLS QA; child_age=under 1 min; owner_pid=26032; child_pid=39996. | 28% | after PlatformGate and candidate model PASS | Low |
| Fast-Track Accelerator | Push short autonomous status, prediction, candidate and expansion actions every 5 minutes. | 2026-06-07T23:02:02Z - PLATFORM_GATE_RUNNING | Status PASS; expansion_eligible=false; expansion_started_this_cycle=false; total_strm=31. | 25% | runs every 5 minutes | Low |
...
- 2026-06-07T23:01:06Z - Durable PlatformGate runner REVIEW: Step platform_gate_review; owner_pid=35764; child_pid=
- 2026-06-07T23:01:06Z - PlatformGate checkpoint REVIEW: Step platform_gate_review; visible=1; blockers=0
