...
Updated UTC: 2026-06-19T17:04:34Z
...
- `O-PLAYBACK`: Plex background scanner/analyzer pressure still detected: 26.
...
|---|---:|---:|---:|
| `JasonOS_Prime_PlaybackFirstStabilityGuard` | `True` | `Ready` | `267009` |
