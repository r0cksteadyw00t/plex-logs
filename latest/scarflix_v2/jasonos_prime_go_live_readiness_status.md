...
Updated UTC: 2026-06-13T21:38:31Z
...
- `O-PLAYBACK`: Plex background scanner/analyzer pressure still detected: 6.
- `O-PLAYBACK`: Playback path recovery is not PASS: REVIEW.
- `O-SCARFLIX-CATALOGUE`: Materialized QA is not PASS: HELD_PLAYBACK_PATH_RECOVERY 0/0 failed=0.
