...
- Updated UTC: 2026-06-09T12:04:51Z
- Source basis: public dashboard/status files only; no local probes or long validation were run.
- Public dashboard latest observed UTC: 2026-06-09T12:04:02.082Z
...
- Latest child QA evidence still references a timeout for `The Bourne Identity`
- Direct STRM admission is `REVIEW_RETRY_HELD` with retryable provider/source reasons
- Playback QA controller is `WAITING_OVERLAP`; detached workers are expected to continue
...
- Bridge updated UTC: 2026-06-09T12:02:02.239Z
- Consumer status: `PASS`
- Consumer updated UTC: 2026-06-09T12:02:02.615Z
